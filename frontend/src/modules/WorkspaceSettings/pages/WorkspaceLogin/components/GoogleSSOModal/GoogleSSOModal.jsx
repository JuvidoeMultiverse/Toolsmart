...
import WorkspaceSSOEnableModal from '@/_components/WorkspaceSSOEnableModal';

const GoogleSSOModal = ({ settings, onClose, onUpdateSSOSettings, isInstanceOptionEnabled }) => {
